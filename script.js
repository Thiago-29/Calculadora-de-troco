...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function calcularTrocoPorCedulas(troco) {
        ...
        for (const valor of cedulasEMoedasEmCentavos) {
            if (trocoCalculado[valor]) {
                ...
                // A moeda de R$ 2,00 é considerada nota para fins de exibição.
                // Aqui garantimos que apenas valores abaixo de R$ 2,00 sejam chamados de "moeda"
                const tipo = valorReal >= 2 ? 'nota' : 'moeda'; 
    ...
    calcularBtn.addEventListener('click', () => {
        ...
        // 1. Validação de Entrada (Valor Invalido)
